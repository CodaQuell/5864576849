...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('mute')
        .setDescription('Mute a server member')
    ...
    async execute(interaction) {
        ...
        .setTitle('Error')
        .setDescription(`You don't have permission to mute members in this server`)
        .setTimestamp()
        ...
        if (role == null) {
            ...
            const embed = new EmbedBuilder()
              .setColor('DarkButNotBlack')
              .setDescription(`${member} has been muted by ${user}`)
              .setTitle(`User Muted`)
              .setTimestamp()
              .setFooter({ text: `Alto Moderation System`})
            ...
            .setDescription(`You have been muted in ${interaction.guild.name} a moderator`)
            .setTimestamp()
            .setFooter({ text: `Alto Moderation System`})
